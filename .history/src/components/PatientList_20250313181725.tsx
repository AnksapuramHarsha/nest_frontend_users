                    ...
                    <div className="bg-white p-6 rounded-lg shadow-xl border border-gray-300 w-[90vw] max-h-[80vh] overflow-y-auto transition-all duration-300 ease-in-out transform hover:scale-105 hover:ring-4 hover:ring-blue-400 focus-within:ring-4 focus-within:ring-blue-500">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="prefe" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
