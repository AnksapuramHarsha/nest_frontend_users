                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditData({ ...editData, genderIdentity: e.target.value })}
                                >
                            ...
                            <div className="flex justify-end mt-4">
                                <button className="bg-gray-400 text-white px-4 py-2 rounded mr-2" onClick={() => { setIsEditing(false);  // ✅ Hide edit modal
