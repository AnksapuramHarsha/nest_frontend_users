...
const PatientList: React.FC<PatientListProps> = ({ networkId }) => {
    ...
    return (
        <div className="p-6 bg-white shadow-lg rounded-lg">
            ...
            {isCreateModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80 backdrop-blur-md p-6 w-full h-full">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-[90vw] h-[90vh] overflow-y-auto mt-20">
                        <h2 className="text-xl font-bold mb-4 text-gray-700 text-center">Create New Patient</h2>

                        <div className="grid grid-cols-3 gap-4">
                            {/* Network ID */}
                            <div className="col-span-3">
                                <label className="text-gray-600">Network ID</label>
                                <input type="text" name="networkId" value={networkId} disabled className="w-full p-2 border rounded bg-gray-100" />
                            </div>

                            {/* UPID */}
                            <div className="col-span-3 mt-4">
                                <h3 className="text-lg font-semibold text-gray-700 border-b pb-2">Identification Details</h3>
                            </div>
                            <div>
                            ...
                            <div className="col-span-3 mt-4">
    <h3 className="text-lg font-semibold text-gray-700 border-b pb-2">Record Information</h3>
</div>
                            <div>
                                <label className="text-gray-600">Created By</label>
                                <input type="text" name="createdBy" onChange={handleCreateInputChange} className="w-full p-2 border rounded" />
                            </div>
                            <div>
                                <label className="text-gray-600">Updated By</label>
                                <input type="text" name="updatedBy" onChange={handleCreateInputChange} className="w-full p-2 border rounded" />
                            </div>

                            {/* Active Status */}
                            <div>
                                <label className="text-gray-600">Active Status</label>
                                <select name="active" onChange={handleCreateInputChange} className="w-full p-2 border rounded">
