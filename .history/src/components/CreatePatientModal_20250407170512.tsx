...
import { INDIAN_LANGUAGES } from "../types/indianLanguages";
...
const CreatePatientModal: React.FC<CreatePatientModalProps> = ({ accessToken, onClose, onUpdate }) => {
    ...
    const validate = () => {
        ...
        if (!formData.abha) {
            ...
            const abhaRegex = /^ABHA_\d{5}$/;
            if (!abhaRegex.test(formData.abha)) {
                tempErrors.abha = "ABHA must be in the format 'ABHA_XXXXX' where X is a digit";
            }
        }
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full p-2 border border-gray-300 rounded" onChange={handleChange}
                                    required
                                >
