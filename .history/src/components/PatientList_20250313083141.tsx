        ...
        <div className="p-6 bg-white shadow-lg rounded-lg">
            ...
            {isCreateModalOpen && (
                <div className="fixed mt-15 inset-0 flex items-center justify-center bg-white bg-opacity-80 backdrop-blur-md w-full h-full">
                    <div className="bg-white p-6 rounded-lg shadow-xl border border-gray-300 w-[90vw] max-h-[90vh] overflow-y-auto transition-all duration-300 ease-in-out transform hover:scale-105 hover:ring-4 hover:ring-blue-400 focus-within:ring-4 focus-within:ring-blue-500">
                        {/* Modal Title */}
                        <h2 className="text-2xl font-semibold sticky top-0 mb-4 text-gray-800 text-center">Create New Patient</h2>
