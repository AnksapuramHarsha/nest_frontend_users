        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* <div>
            ...
            <input
              type="date"
              name="deathDate"
              value={formData.deathDate ? new Date(formData.deathDate).toISOString().split("T")[0] : null}
              onChange={(e) => setFormData((prev) => ({
                ...prev,
                deathDate: e.target.value ? e.target.value : null, // Convert empty string to null
              }))}
              className="w-full p-2 border border-gray-300 rounded"
            />
          </div> */}
