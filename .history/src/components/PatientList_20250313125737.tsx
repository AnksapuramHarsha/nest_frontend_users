...
const PatientList: React.FC<PatientListProps> = ({ networkId }) => {
    ...
    const handleDelete = async (upid: string) => {
        ...
        try {
            await deletePatient(upid, accessToken); // ✅ Use 'upid'
        ...
        setEditFormData((prev) => {
            if (name.startsWith("address.")) {
                ...
                return {
                    ...prev,
                    address: {
                        ...(prev.address ?? {}), // ✅ Ensure 'address' is always an object
                        [addressField]: value,
                    },
                };
            }
            ...
            if (name.startsWith("contact.")) {
                ...
                return {
                    ...prev,
                    contact: {
                        ...(prev.contact ?? {}), // ✅ Ensure 'contact' is always an object
                        [contactField]: value,
                    },
                };
            }
    ...
    const handleUpdate = async () => {
        ...
        try {
            const updatedPatient = await updatePatient(selectedPatient.upid, { ...editFormData }, accessToken); // ✅ Use 'upid'
            toast.success("Patient updated successfully.");
    
            // Fetch updated patients from backend
            const updatedPatients = await fetchPatientsByNetwork(networkId, accessToken);
            setPatients(updatedPatients);
    ...
    return (
        <div className="p-6 bg-white shadow-lg rounded-lg">
            ...
            {isCreateModalOpen && (
                <div className="fixed mt-15 inset-0 flex items-center justify-center bg-white bg-opacity-80 backdrop-blur-md w-full h-full">
                    <div className="bg-white p-6 rounded-lg shadow-xl border border-gray-300 w-[90vw] max-h-[80vh] overflow-y-auto transition-all duration-300 ease-in-out transform hover:scale-105 hover:ring-4 hover:ring-blue-400 focus-within:ring-4 focus-within:ring-blue-500">
                        {/* Modal Title */}
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="col-span-3">
                                ...
                                <input
                                    ...
                                    value={networkId}
                                    disabled
                                    className="w-auto min-w-[200px] p-2 border border-gray-300 bg-gray-100 text-gray-500 rounded-md cursor-not-allowed"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="identifier.aadhar" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">PAN Number</label>
                                <input type="text" name="identifier.pan" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="namePrefix" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">First Name</label>
                                <input type="text" name="nameGiven" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">Middle Name</label>
                                <input type="text" name="nameMiddle" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="birthDate" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">Gender Identity</label>
                                <input type="text" name="genderIdentity" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>

                            {/* Address */}
                            <div className="col-span-3">
                                <label className="text-gray-700">Address Line 1</label>
                                <input type="text" name="address.line1" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">City</label>
                                <input type="text" name="address.city" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">State</label>
                                <input type="text" name="address.state" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">Postal Code</label>
                                <input type="text" name="address.postalCode" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>

                            {/* Contact Details */}
                            <div>
                                <label className="text-gray-700">Email</label>
                                <input type="email" name="contact.email" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">Phone</label>
                                <input type="text" name="contact.phone" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="createdBy" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
                            <div>
                                <label className="text-gray-700">Updated By</label>
                                <input type="text" name="updatedBy" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md transition-all duration-200 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300" />
                            </div>
