...
{isCreateModalOpen && (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm p-6 w-full h-full">
        <div className="bg-white p-6 rounded-lg shadow-xl border border-gray-300 w-[90vw] max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="upid" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md" />
                </div>
                <div>
                    <label className="text-gray-700">ABHA Number</label>
                    <input type="text" name="abha" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md" />
                </div>
                <div>
                    <label className="text-gray-700">MRN Number</label>
                    <input type="text" name="mrn" onChange={handleCreateInputChange} className="w-full p-2 border border-gray-300 rounded-md" />
                </div>
                <div>
