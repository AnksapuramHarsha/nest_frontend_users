                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <input type="text" name="contactMethod" value={formData.preferences.contactMethod} onChange={handleChange} />

                            <label className="block">Appointment Reminders:</label>
                            <select name="appointmentReminders" value={formData.preferences.appointmentReminders ? "true" : "false"} onChange={handleChange}>
                                <option value="false">No</option>
                                <option value="true">Yes</option>
                            </select>
                        </div>  
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <select name="livingWill" value={formData.advanceDirectives.livingWill ? "true" : "false"} onChange={handleChange}>
                                <option value="false">No</option>
                                <option value="true">Yes</option>
                            </select>

                            <label className="block">Power of Attorney:</label>
                            <input type="text" name="powerOfAttorney" value={formData.advanceDirectives.powerOfAttorney} onChange={handleChange} />
                        </div>
                    </div>
