...
//       <div className="mt-4">
//         <p className="text-3xl font-bold">Welcome {profile.firstName}</p>
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="p-6  mt-6 bg-gradient-to-r from-blue-50 via-indigo-100 to-indigo-200 min-h-screen">
