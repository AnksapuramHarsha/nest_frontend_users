...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-teal-400 to-blue-500 bg-cover bg-center animate-pulse">
      <div className="w-full max-w-md p-8 bg-white bg-opacity-90 rounded-lg shadow-xl transform transition-all duration-500 hover:scale-105 animate__animated animate__fadeIn">
